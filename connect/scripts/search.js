                  ...
                  if (first_page_match) {
                    ...
                    for (page_match_index = 0; page_match_index < word_page_matches.length; page_match_index += 1) {
                      ...
                      if (pages[page_with_score.page[0]] !== undefined) {
                        if (pages[page_with_score.page[0]].score < page_with_score.score) {
...
Search.Load = function () {
  ...
  //
  var onSearchLinkClick, onSearchLinkClickInBaggage, onSearchLinkClickInExternalBaggage, onSearchComplete, search_page_load_data;
  ...
  onSearchLinkClickInExternalBaggage = function (param_event) {
    ...
    params = "wwreverbsearch_action=search_display_link" +
      "&wwreverbsearch_highlightRequireWhitespace=" + encodeURIComponent(require_whitespace) +
      "&wwreverbsearch_query=" + encodeURIComponent(Search.query) +
      "&wwreverbsearch_synonyms=" + encodeURIComponent(Search.control.all_synonyms);
